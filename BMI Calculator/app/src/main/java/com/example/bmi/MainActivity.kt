    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnBmi.setOnClickListener {
            ...
            if (etWeight.text.isEmpty() or etHeight.text.isEmpty()){
                Toast.makeText(this,"Enter your Weight or Height",Toast.LENGTH_LONG).show()
            }
            else {
                ...
                when (bmi) {
                    in 0.0..18.4 -> tvResult.text = "Status : " + "Underweight \n" + "BMI = " + bmi.toInt().toString()
                    in 18.5..24.9 -> tvResult.text = "Status : " + "Normal weight \n" + "BMI = " + bmi.toInt().toString()
